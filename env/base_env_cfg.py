...
# Pre-defined configs
##
from .rough_terrain_cfg import ROUGH_TERRAINS_CFG  # isort: skip
...
from ainex_cfg import AINEX_COLLISION_CFG as AINEX_CFG, joint_names  # isort:skip
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    dome_light = AssetBaseCfg(
        prim_path="/World/skyLight", spawn=sim_utils.DomeLightCfg(intensity=3000.0, color=(0.75, 0.75, 0.75))
    )
