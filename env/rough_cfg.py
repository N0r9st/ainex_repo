...
#     RewardsCfg,
# )
from .base_env_cfg import LocomotionVelocityRoughEnvCfg, RewardsCfg
...
class H1Rewards(RewardsCfg):
    ...
    feet_slide = RewTerm(
        ...
        params={
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_ank_roll_link"),
            "asset_cfg": SceneEntityCfg("robot", body_names=".*_ank_roll_link"),
        },
    )
...
class H1RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # Scene
        self.scene.robot = AINEX_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
